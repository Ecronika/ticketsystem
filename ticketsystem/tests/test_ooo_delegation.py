...
def test_circular_delegation(test_app):
    w1 = WorkerService.create_worker("W1", "7391")
    w2 = WorkerService.create_worker("W2", "8264")
    w3 = WorkerService.create_worker("W3", "9173")
...
def test_linear_delegation(test_app):
    w4 = WorkerService.create_worker("L1", "7391")
    w5 = WorkerService.create_worker("L2", "8264")
