...
def register_routes(bp):
    ...
    @bp.route('/settings/backup/config', methods=['POST'])
    ...
    @bp.route('/settings/backup/download/<filename>')
    ...
    @bp.route('/toggle_migration_mode', methods=['POST'])
    ...
    @bp.route('/add_examiner', methods=['POST'])
    def add_examiner():
        """Add a new examiner."""
    ...
    @bp.route('/add_azubi', methods=['POST'])
    def add_azubi():
        """Add a new azubi."""
    ...
    @bp.route('/add_werkzeug', methods=['POST'])
    def add_werkzeug():
        """Add a new tool."""
