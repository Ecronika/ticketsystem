...
def register_routes(bp):
    ...
    @bp.route('/check/<int:azubi_id>', methods=['GET'])
    ...
    @bp.route('/submit_check', methods=['POST'])
    def submit_check():
    ...
    @bp.route('/exchange_tool', methods=['POST'])
    def exchange_tool():
    ...
    @bp.route('/history_details/<path:session_id>')
    ...
    @bp.route('/download_report/<path:filename>')
    ...
    @bp.route('/delete_session/<path:session_id>',
              methods=['POST'])
    def delete_session(session_id):
        ...
        if not session.get('migration_mode', False):
            current_app.logger.warning(
                "Delete session attempted WITHOUT "
